...
const user = 'victor13572468@gmail.com';
const pass = 'Victor1357';
...
const url = 'https://www.nike.com.br/Produto/Tenis-Nike-Air-Zoom-Winflo-7-Masculino/153-169-224-249155?gridPosition=A2';
...
(async () => { 
	...
	await page.evaluate(async(size) => {
		let sizes = await Array.from(document.querySelectorAll(".variacoes-tamanhos__lista"));
		let sizeIndex = sizes
